...
-- changeset Lukas:20221020101800-1
UPDATE public."Resources"
SET "SubTypes" = ARRAY ["AgreementType" + 2000]
WHERE "Type" = 2;

-- changeset Lukas:20221020101800-2
ALTER TABLE public."Resources"
    RENAME COLUMN "AgreementType" TO "PeriodAggregationUnit";

-- changeset Lukas:20221020101800-3
CREATE
...
BEGIN SELECT "Id"
    ...
    INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "ExternalId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber",
                      "VersionDateTime", "ConstraintType", "PeriodAggregationUnit", "IsActive", "AgreedFTE", "PlannedEffort", "RemainingEffort", "Plannable", "SubTypes", "Token")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."ExternalId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom",
            ...
            rRow."PlannedEffort",
            rRow."RemainingEffort", rRow."Plannable", rRow."SubTypes", rRow."Token")
    ;
    END LOOP;
    ...
    FOR tRow IN SELECT *
                ...
                WHERE "ScenarioId" = productionScenarioId
                    LOOP
    INSERT INTO "Tasks" ("Id", "ScenarioId", "ExternalId", "TenantId", "DateTimeFrom", "DateTimeTo", "IsDateTimeFromStrict", "IsDateTimeToStrict", "Name", "Priority", "Type",
    ...
    VALUES (stsRow."TenantId", "scenarioId", stsRow."TaskId", stsRow."StepId", stsRow."ExecutionStatus", stsRow."ExecutionStart", stsRow."ExecutionEnd", stsRow."ExecutionDuration",
    ...
    FOR srsRow IN SELECT *
                  ...
                  WHERE "ScenarioId" = productionScenarioId
                      LOOP
    INSERT INTO "StepResourceSpecs" ("Id", "ScenarioId", "TenantId", "StepId", "ResourceId", "Quantity", "AssignmentType", "QuantityUnit", "UsageType", "CapabilityRequirements",
                                     "ResourceType", "ProcessingTime", "QuantityPerTime", "AlternativeResourceIds")
    VALUES (srsRow."Id", "scenarioId", srsRow."TenantId", srsRow."StepId", srsRow."ResourceId", srsRow."Quantity", srsRow."AssignmentType", srsRow."QuantityUnit",
            srsRow."UsageType", srsRow."CapabilityRequirements", srsRow."ResourceType", srsRow."ProcessingTime", srsRow."QuantityPerTime", srsRow."AlternativeResourceIds")
    ;
    END LOOP;
    ...
    FOR ttsRow IN SELECT *
                  ...
                  WHERE "ScenarioId" = productionScenarioId
                      LOOP
    INSERT INTO "TaskExecutionStatistics" ("TenantId", "ScenarioId", "TaskId", "ExecutionStatus", "ExecutionStart", "ExecutionEnd", "ExecutionDuration", "ExecutionLeadTime",
    ...
    FOR tssRow IN SELECT *
                  ...
                  WHERE "ScenarioId" = productionScenarioId
                      LOOP
    INSERT INTO "TaskSchedulingStatistics" ("ScenarioId", "TenantId", "TaskId", "SchedulingStatus", "SchedulingStart", "SchedulingEnd", "SchedulingDuration", "SchedulingLeadTime",
    ...
    FOR rcRow IN SELECT *
                 ...
                 WHERE "ScenarioId" = productionScenarioId
                     LOOP
    INSERT INTO "ResourceCapacities" ("Id", "ScenarioId", "TenantId", "ResourceId", "TaskId", "StepId", "StepResourceSpecId", "Quantity", "ChangeType", "PeriodStart", "PeriodEnd",
