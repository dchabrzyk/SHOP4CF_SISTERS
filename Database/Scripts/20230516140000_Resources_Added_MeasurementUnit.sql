...
-- changeset Sko:20230516140000-1
ALTER TABLE public."Resources"
    ADD COLUMN "MeasurementUnit" integer DEFAULT 0;


-- changeset Sko:20230516140000-2
CREATE
...
BEGIN SELECT "Id"
    ...
    FOR miRow IN SELECT *
                 ...
                 WHERE "ScenarioId" = productionScenarioId
                     LOOP
    INSERT
    INTO "ModelInstances" ("Id", "ScenarioId", "TenantId", "Schema", "Version", "Value", "ExternalId")
    ...
    INSERT
        INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "ExternalId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber",
                          ...
                          "Token", "TrackingType", "MeasurementUnit")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."ExternalId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom",
            ...
            rRow."PlannedEffort",
            rRow."RemainingEffort", rRow."Plannable", rRow."SubTypes", rRow."Token", rRow."TrackingType", rRow."MeasurementUnit")
    ;
    END LOOP;
