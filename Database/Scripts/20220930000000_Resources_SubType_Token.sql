...
-- changeset GO:20220930000000-1
ALTER TABLE public."Resources" ADD COLUMN "SubType" integer DEFAULT 0;

-- changeset GO:20220930000000-2
ALTER TABLE public."Resources" ADD COLUMN "Token" character varying(255) COLLATE pg_catalog."default" DEFAULT NULL;

-- changeset GO:20220930000000-3
CREATE
...
BEGIN
    ...
    LOOP
    -- Resource
    -- Note: added SubType, Token
    INSERT INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "ExternalId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber", "VersionDateTime", "AgreementType", "IsActive", "AgreedFTE", "PlannedEffort", "RemainingEffort", "Plannable", "SubType", "Token")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."ExternalId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom", rRow."DateTimeTo", rRow."VersionNumber", rRow."VersionDateTime", rRow."AgreementType", rRow."IsActive", rRow."AgreedFTE", rRow."PlannedEffort", rRow."RemainingEffort", rRow."Plannable", rRow."SubType", rRow."Token")
    ;
    END LOOP;
