...
-- changeset Sko:20230109100000-1
ALTER TABLE public."Resources" ADD COLUMN "TrackingType" integer DEFAULT 0;


-- changeset Sko:20230109100000-2
CREATE
...
BEGIN SELECT "Id"
    ...
    INSERT
        INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "ExternalId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber",
                          "VersionDateTime", "ConstraintType", "PeriodAggregationUnit", "IsActive", "AgreedFTE", "PlannedEffort", "RemainingEffort", "Plannable", "SubTypes", "Token", "TrackingType")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."ExternalId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom",
            ...
            rRow."PlannedEffort",
            rRow."RemainingEffort", rRow."Plannable", rRow."SubTypes", rRow."Token", rRow."TrackingType")
    ;
    END LOOP;
