...
-- changeset Lukas:20211227113500-1
ALTER TABLE public."Tasks" DROP COLUMN "PlannedCycles";

-- changeset Lukas:20211227113500-2
ALTER TABLE public."Tasks" DROP COLUMN "PlannedScrapCycles";

-- changeset Lukas:20211227113500-3
ALTER TABLE public."Tasks" DROP COLUMN "RemainingCycles";

-- changeset Lukas:20211227113500-4
ALTER TABLE public."Steps" RENAME COLUMN "TimePerCycleQuantity" TO "QuantityPerTime";

-- changeset Lukas:20211227113500-5
ALTER TABLE public."Steps" DROP COLUMN "TimePerCycle";

-- changeset Lukas:20211227113500-6
ALTER TABLE public."StepResources" RENAME TO "StepResourceSpecs";

-- changeset Lukas:20211227113500-7
ALTER TABLE public."StepResourceSpecs" RENAME COLUMN "FixedQuantityValue" TO "QuantityValue";

-- changeset Lukas:20211227113500-8
ALTER TABLE public."StepResourceSpecs" RENAME COLUMN "FixedQuantityUnit" TO "QuantityUnit";

-- changeset Lukas:20211227113500-9
ALTER TABLE public."StepResourceSpecs" DROP COLUMN "QuantityPerCycleValue";

-- changeset Lukas:20211227113500-10
ALTER TABLE public."StepResourceSpecs" DROP COLUMN "QuantityPerCycleUnit";

-- changeset Lukas:20211227113500-11
ALTER TABLE public."StepResourceSpecs"
    ADD COLUMN "ProcessingTime" interval;

-- changeset Lukas:20211227113500-12
ALTER TABLE public."StepResourceSpecs"
    ADD COLUMN "QuantityPerTime" numeric;

-- changeset Lukas:20211227113500-13
CREATE
