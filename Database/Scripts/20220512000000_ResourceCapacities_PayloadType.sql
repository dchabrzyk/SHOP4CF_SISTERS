...
-- changeset Gchegosh:20220512000000-1
ALTER TABLE "ResourceCapacities"
    ADD COLUMN "EntrySourcePayloadType" character varying(255) COLLATE pg_catalog."default" DEFAULT NULL;

-- changeset Gchegosh:20220512000000-2
UPDATE "ResourceCapacities"
    SET "EntrySourcePayloadType" = "EntrySourcePayload", "EntrySourcePayload" = NULL
    WHERE "EntrySourcePayload" IS NOT NULL;

-- changeset Gchegosh:20220512000000-3
CREATE
...
BEGIN
    ...
    -- Resource capacities
    -- Note: new EntrySourcePayloadType
