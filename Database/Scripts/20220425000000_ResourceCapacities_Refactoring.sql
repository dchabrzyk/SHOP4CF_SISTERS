...
-- changeset Gchegosh:20220425000000-1

ALTER TABLE "StepResourceSpecs"
    RENAME COLUMN "QuantityValue" TO "Quantity";

ALTER TABLE "ResourceCapacities"
    RENAME COLUMN "Group" TO "CapacityGroup";

ALTER TABLE "ResourceCapacities"
    RENAME COLUMN "WorkQuantityValue" TO "Quantity";

ALTER TABLE "ResourceCapacities"
    RENAME COLUMN "WorkQuantityUnit" TO "QuantityUnit";

-- changeset Gchegosh:20220425000000-2
...
BEGIN
    ...
    -- Step Resource Specs
    -- Note: rename QuantityValue -> Quantity
    ...
    -- Resource capacities
    -- Note: rename Group -> CapacityGroup, WorkQuantityValue -> Quantity, WorkQuantityUnit -> QuantityUnit
    FOR rcRow IN SELECT * FROM "ResourceCapacities" WHERE "ScenarioId" = productionScenarioId
    LOOP
    INSERT INTO "ResourceCapacities" ("Id", "ScenarioId", "TenantId", "ResourceId", "TaskId", "StepId", "StepResourceSpecId", "Quantity", "ChangeType", "PeriodStart", "PeriodEnd", "EntrySource", "EntrySourcePayload", "QuantityUnit", "CapacityGroup", "ContextResourceId", "ExternalContextResourceId")
    VALUES (uuid_generate_v4(), "scenarioId", rcRow."TenantId", rcRow."ResourceId", rcRow."TaskId", rcRow."StepId", rcRow."StepResourceSpecId", rcRow."Quantity", rcRow."ChangeType", rcRow."PeriodStart", rcRow."PeriodEnd", rcRow."EntrySource", rcRow."EntrySourcePayload", rcRow."QuantityUnit", rcRow."CapacityGroup", rcRow."ContextResourceId", rcRow."ExternalContextResourceId")
    ;
    END LOOP;
