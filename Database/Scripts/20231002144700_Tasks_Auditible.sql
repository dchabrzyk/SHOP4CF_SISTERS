...
-- changeset Lukas:20231002144700-1
...
-- changeset Lukas:20231002144700-2
...
BEGIN SELECT "Id"
    ...
    INSERT
        INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "BusinessId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber",
                          ...
                          "Token", "TrackingType", "MeasurementUnit", "Description", "CreatedBy", "CreatedAt", "ModifiedBy", "ModifiedAt")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."BusinessId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom",
            ...
            rRow."CreatedBy", rRow."CreatedAt", rRow."ModifiedBy", rRow."ModifiedAt");
    END LOOP;
    ...
    FOR tRow IN SELECT *
                ...
                WHERE "ScenarioId" = productionScenarioId
                    LOOP
    INSERT
        INTO "Tasks" ("Id", "ScenarioId", "BusinessId", "TenantId", "DateTimeFrom", "DateTimeTo", "IsDateTimeFromStrict", "IsDateTimeToStrict", "Name", "Priority",
                      "Type", "TaskTimeBoxId", "ParentTaskId", "RootTaskId", "Wbs", "CreatedBy", "CreatedAt", "ModifiedBy", "ModifiedAt")
    ...
    FOR stsRow IN SELECT *
                  ...
                  WHERE "ScenarioId" = productionScenarioId
                      LOOP
    INSERT
        INTO "StepExecutionStatistics" ("TenantId", "ScenarioId", "TaskId", "StepId", "ExecutionStatus", "ExecutionStart", "ExecutionEnd", "ExecutionDuration",
    ...
    INSERT
        INTO "ResourceCapacities" ("Id", "ScenarioId", "TenantId", "ResourceId", "TaskId", "StepId", "StepResourceSpecId", "Quantity", "ChangeType", "PeriodStart",
                                   "PeriodEnd",
                                   "EntrySource", "EntrySourcePayload", "QuantityUnit", "CapacityGroup", "ContextResourceId", "ContextResourceBusinessId",
    ...
    VALUES (uuid_generate_v4(), "scenarioId", rcRow."TenantId", rcRow."ResourceId", rcRow."TaskId", rcRow."StepId", rcRow."StepResourceSpecId", rcRow."Quantity",
            ...
            rcRow."ContextResourceId", rcRow."ContextResourceBusinessId", rcRow."EntrySourcePayloadType");
    END LOOP;
