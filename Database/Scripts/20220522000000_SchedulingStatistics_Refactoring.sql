...
-- changeset Gchegosh:20220522000000-1
ALTER TABLE "StepSchedulingStatistics"
    DROP COLUMN "SchedulingBufferDelay";

-- changeset Gchegosh:20220522000000-2
ALTER TABLE "TaskSchedulingStatistics"
    RENAME COLUMN "SchedulingBufferDelay" TO "SchedulingDelay";

-- changeset Gchegosh:20220522000000-3
ALTER TABLE "TaskSchedulingStatistics"
    ADD COLUMN "RequestedEnd" timestamp without time zone;

-- changeset Gchegosh:20220522000000-4
CREATE
...
BEGIN
    ...
    -- Note: removed SchedulingBufferDelay
