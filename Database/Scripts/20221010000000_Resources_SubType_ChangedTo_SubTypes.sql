...
-- changeset Sko:20221010000000-1
ALTER TABLE public."Resources"
    RENAME COLUMN "SubType" TO "SubTypes";

ALTER TABLE public."Resources"
    ALTER COLUMN "SubTypes" DROP DEFAULT;

ALTER TABLE public."Resources"
    ALTER COLUMN "SubTypes" set data type integer[] using nullif(array["SubTypes"], '{null}');

ALTER TABLE public."Resources"
    ALTER COLUMN "SubTypes" SET DEFAULT array[0];

ALTER TABLE public."Resources"
    DROP COLUMN "MaterialTypes";

-- changeset Sko:20221010000000-2
CREATE
...
BEGIN
    ...
    LOOP
    -- Resource
    -- Note: added SubTypes, Token
    INSERT INTO "Resources" ("Id", "ScenarioId", "TenantId", "Name", "ParentId", "Type", "ExternalId", "Color", "IsBase", "DateTimeFrom", "DateTimeTo", "VersionNumber", "VersionDateTime", "AgreementType", "IsActive", "AgreedFTE", "PlannedEffort", "RemainingEffort", "Plannable", "SubTypes", "Token")
    VALUES (rRow."Id", "scenarioId", rRow."TenantId", rRow."Name", rRow."ParentId", rRow."Type", rRow."ExternalId", rRow."Color", rRow."IsBase", rRow."DateTimeFrom", rRow."DateTimeTo", rRow."VersionNumber", rRow."VersionDateTime", rRow."AgreementType", rRow."IsActive", rRow."AgreedFTE", rRow."PlannedEffort", rRow."RemainingEffort", rRow."Plannable", rRow."SubTypes", rRow."Token")
    ;
    END LOOP;
