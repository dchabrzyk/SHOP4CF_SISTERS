...
-- changeset Koza:20211025142500-1 rollbackSplitStatements:false

ALTER TABLE public."StepResources"
    ADD COLUMN "RequiredCapabilities" jsonb;

--rollback ALTER TABLE public."StepResources" DROP COLUMN "RequiredCapabilities";

-- changeset Koza:20211025142500-2 rollbackSplitStatements:false
...
--rollback 		-- create copy
--rollback 		WITH inserted_row AS (
--rollback 			INSERT INTO "StepResources" ("Id", "ScenarioId", "OrganizationId", "StepId", "ResourceId", "FixedQuantityValue", "UseChildrenAsAlternatives", "AlternativesCategory", "FixedQuantityUnit", "QuantityPerCycleValue", "QuantityPerCycleUnit", "UsageType")
--rollback 			VALUES (uuid_generate_v4(), "scenarioId", tsrRow."OrganizationId", stepId, resourceId, tsrRow."FixedQuantityValue", tsrRow."UseChildrenAsAlternatives", tsrRow."AlternativesCategory", tsrRow."FixedQuantityUnit", tsrRow."QuantityPerCycleValue", tsrRow."QuantityPerCycleUnit", tsrRow."UsageType")
--rollback 			RETURNING "Id"
--rollback 		)
--rollback 		INSERT INTO "IdMappings" ("OldId", "NewId")
